...
- 2925	frp	firewall redundancy protocol
- 2926	mobile-file-dl	MOBILE-FILE-DL
- 2927	unimobilectrl	UNIMOBILECTRL
- 2928	redstone-cpss	REDSTONE-CPSS
- 2929	panja-webadmin	PANJA-WEBADMIN
- 2930	panja-weblinx	PANJA-WEBLINX
...
- 2987	identify	ResolveNet IOM IDENTIFY
- 2988	classify	ResolveNet IOM CLASSIFY
- 2989	zarkov	ZARKOV
- 2990	boscap	BOSCAP
...
- 3031	agentvu	AgentVU
- 3032	redwood-chat	Redwood Chat
- 3033	pdb	PDB
- 3034	osmosis-aeea	Osmosis AEEA
...
- 3128	squid-http	squid-http 3128/tcp
- 3129	trojan	Masters Paradise Trojan
- 3130	icpv2	ICPv2
...
- 3672	harlequinorb	harlequinorb
- 3700	trojan	Portal of Doom Trojan
- 3802	vhd	VHD
...
- 4042	ldxp	LDXP
- 4045	lockd	lockd 4045/tcp
- 4092	trojan	WinCrash Trojan
...
- 4557	fax	flexfax fax transmission service, fax transmission service
- 4559	hylafax	hylafax client-server protocol
- 4567	tram	TRAM
- 4568	bmc-reporting	BMC Reporting
- 4590	trojan	ICQTrojan Trojan
...
- 4885	abbs	ABBS
- 4950	trojan	ICQTrojan Trojan
- 4983	att-intercom	AT&T Intercom
...
- 5055	unot	UNOT
- 5056	intecom-ps1	Intecom PS 1
- 5057	intecom-ps2	Intecom PS 2
- 5060	sip	SIP
...
- 5200	targus-aib1	targus aib 1
- 5201	targus-aib2	targus aib 2
...
- 5321	trojan	Firehotcker Trojan
...
- 5454	apc-tcp-udp-4	apc-tcp-udp-4
- 5455	apc-tcp-udp-5	apc-tcp-udp-5
- 5456	apc-tcp-udp-6	apc-tcp-udp-6
...
- 5680	canna	canna (japanese input), kana->kanji server
...
- 5730	unieng	netscape suiteware
- 5731	unisnc	netscape suiteware
- 5732	unidas	netscape suiteware
...
- 5800	vnc	vnc 5800/tcp
- 5801	vnc	vnc 5801/tcp
- 5813	icmpd	ICMPD
- 5859	wherehoo	WHEREHOO
- 5900	vnc	virtual network computer, orl virtual network client
...
- 5999	cvsup	CVSup
- 6000	x11	x window system, x window server, x-windows server
- 6001	x11	x window system, x window server, x-windows server
- 6002	x11	x window system, x window server, x-windows server
- 6003	x11	x window system, x window server, x-windows server
- 6004	x11	x window system, x window server, x-windows server
- 6005	x11	x window system, x window server, x-windows server
- 6006	x11	x window system, x window server, x-windows server
- 6007	x11	x window system, x window server, x-windows server
- 6008	x11	x window system, x window server
- 6009	x11	x window system, x window server
...
- 6346	gnutella	gnutella, the gnu napster
- 6347	gnutella-rtr	gnutella-rtr
- 6389	clariion-evr01	clariion-evr01
- 6400	info-aps	info-aps 6400/tcp
- 6401	info-was	info-was 6401/tcp
- 6402	info-eventsvr	info-eventsvr 6402/tcp
- 6403	info-cachesvr	info-cachesvr 6403/tcp
- 6404	info-filesvr	info-filesvr 6404/tcp
- 6405	info-pagesvr	info-pagesvr 6405/tcp
- 6406	info-processvr	info-processvr 6406/tcp
- 6407	reserved1	reserved1 6407/tcp
- 6408	reserved2	reserved2 6408/tcp
- 6409	reserved3	reserved3 6409/tcp
- 6410	reserved4	reserved4 6410/tcp
...
- 6547	apc-tcp-udp-1	apc-tcp-udp-1
- 6548	apc-tcp-udp-2	apc-tcp-udp-2
- 6549	apc-tcp-udp-3	apc-tcp-udp-3
- 6550	fg-sysupdate	fg-sysupdate
- 6558	xdsxdm	
- 6665	ircu	ircu
- 6666	ircu	ircu, internet relay chat server
- 6667	ircu	often used irc port (also see 194), ircu, internet relay chat
- 6668	ircu	ircu, internet relay chat
- 6670	vocaltec-gold	Vocaltec Global Online Directory
- 6671	trojan	Deep Throat Trojan
...
- 6776	trojan	BackDoor-G, SubSeven trojans
- 6790	hnmp	HNMP
...
- 7326	swx	the swiss exchange, internet citizen's band
...
- 7360	swx	the swiss exchange
- 7361	swx	the swiss exchange
- 7362	swx	the swiss exchange
- 7363	swx	the swiss exchange
- 7364	swx	the swiss exchange
- 7365	swx	the swiss exchange
- 7366	swx	the swiss exchange
- 7367	swx	the swiss exchange
- 7368	swx	the swiss exchange
- 7369	swx	the swiss exchange
- 7370	swx	the swiss exchange
- 7371	swx	the swiss exchange
- 7372	swx	the swiss exchange
- 7373	swx	the swiss exchange
- 7374	swx	the swiss exchange
- 7375	swx	the swiss exchange
- 7376	swx	the swiss exchange
- 7377	swx	the swiss exchange
- 7378	swx	the swiss exchange
- 7379	swx	the swiss exchange
- 7380	swx	the swiss exchange
- 7381	swx	the swiss exchange
- 7382	swx	the swiss exchange
- 7383	swx	the swiss exchange
- 7384	swx	the swiss exchange
- 7385	swx	the swiss exchange
- 7386	swx	the swiss exchange
- 7387	swx	the swiss exchange
- 7388	swx	the swiss exchange
- 7389	swx	the swiss exchange
- 7390	swx	the swiss exchange
...
- 7789	trojan	Back Door Setup, ICKiller Trojan
...
- 9535	man	man 9535/tcp
- 9594	msgsys	Message System
- 9595	pds	Ping Discovery Service
- 9600	micromuse-ncpw	MICROMUSE-NCPW
- 9753	rasadv	rasadv
- 9872	trojan	Portal of Doom Trojan
- 9873	trojan	Portal of Doom v1.x Trojan
- 9874	trojan	Portal of Doom v2.x Trojan
- 9875	trojan	Portal of Doom v3.x Trojan
...
- 9950	apcpcpluswin1	APCPCPLUSWIN1
- 9951	apcpcpluswin2	APCPCPLUSWIN2
- 9952	apcpcpluswin3	APCPCPLUSWIN3
- 9989	trojan	iNi-Killer Trojan
- 9992	palace	palace
- 9993	palace	palace
- 9994	palace	palace
- 9995	palace	palace
...
- 10067	trojan	Portal of Doom v4.x Trojan
- 10080	amanda	Amanda
...
- 10115	ganymede-endpt	ganymede endpoint
- 10128	bmc-perf-sd	BMC-PERFORM-SERVICE DAEMON
- 10167	trojan	Portal of Doom v5.x Trojan
- 10288	blocks	Blocks
- 11000	irisa	IRISA
- 11001	metasys	Metasys
- 11111	vce	Viral Computing Environment (VCE)
- 11201	smsqp	smsqp
- 11223	trojan	Progenic trojan Trojan
- 11319	imip	IMIP
...
- 12172	hivep	HiveP
- 12223	trojan	Hack'99 KeyLogger Trojan
- 12345	NetBus	netbus backdoor trojan
- 12346	NetBus	netbus backdoor trojan
- 12361	trojan	Whack-a-mole Trojan
- 12362	trojan	Whack-a-mole Trojan
- 12753	tsaf	tsaf port
- 13000	trojan	Senna Spy Trojan
...
- 14001	itu-sccp-ss7	ITU SCCP (SS7)
...
- 22222	trojan	Prosiak Trojan
- 22273	wnn6	wnn6
- 22289	wnn4_Cn	wnn6 (chinese input), wnn4 (chinese input)
- 22305	wnn4_Kr	wnn4 (korean input), wnn6 (korean input)
- 22321	wnn4_Tw	wnn4 (taiwanse input), wnn6 (taiwanse input)
...
- 23456	trojan	Evil FTP, Ugly FTP, WhackJob
...
- 26000	quake	quake
- 26208	wnn6-ds	wnn6 (dserver), wnn6-ds
- 26262	k3software-svr	K3 Software-Server
- 26264	gserver	Gserver
...
- 30029	trojan	AOL Trojan
- 30100	trojan	Netsphere Trojan
- 30101	trojan	Netsphere Trojan
- 30102	trojan	Netsphere Trojan
- 30303	trojan	Sockets de Troie Trojan
- 31337	Elite	sometimes interesting stuff can be found here
- 31338	trojan	Back Orifice, DeepBO, NetSpy DK Trojan
- 31339	trojan	NetSpy DK Trojan
- 31666	trojan	BOWhack Trojan
...
- 32775	sometimes-rpc13	sometimes an rpc port on my solaris box (status)
- 32776	sometimes-rpc15	sometimes an rpc port on my solaris box (sprayd)
...
- 33333	trojan	Prosiak Trojan
- 33434	traceroute	traceroute use
- 34324	trojan	BigGluck, TN, Tiny Telnet Server Trojan
- 36865	kastenxpipe	KastenX Pipe
- 40412	trojan	BigGluck, TN, The Spy Trojan
- 40421	trojan	Masters Paradise, Agent 4042 Trojan1
- 40422	trojan	Masters Paradise v1.x Trojan
- 40423	trojan	Masters Paradise v2.x Trojan
- 40426	trojan	Masters Paradise v3.x Trojan
- 40841	cscp	CSCP
- 43118	reachout	reachout 43118/tcp
...
- 50505	trojan	Sockets de Troie v2 Trojan.x
- 50766	trojan	Fore, Schwindler Trojan
- 53001	trojan	Remote Windows Shutdown Trojan
- 54321	trojan	School Bus Trojan
- 60000	trojan	Depp Throat Trojan
- 61466	trojan	Telecommando Trojan
- 65000	trojan	Devil v1.03 Trojan
- 65301	pcanywhere	pcanywhere 65301/tcp